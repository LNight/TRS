...
public class ApprovalDTO {
    ...
    public ApprovalDTO(Integer tno, Integer empno, String ename, String startdate, String enddate, Integer tdays, String travelinfo, String reidate, Integer subsidy, Integer totalrei, Integer state, String rejectreason, String process) {
        this.tno = tno;
        this.empno = empno;
        this.ename = ename;
